...
vec3 const& mesh_basic::vertex(int const index) const
{
...
vec3 const& mesh_basic::normal(int const index) const
{
    ASSERT_CPE(index>=0,"Index ("+std::to_string(index)+") must be positive");
...
vec3 const& mesh_basic::color(int const index) const
{
    ASSERT_CPE(index>=0,"Index ("+std::to_string(index)+") must be positive");
...
vec2 const& mesh_basic::texture_coord(int const index) const
{
    ASSERT_CPE(index>=0,"Index ("+std::to_string(index)+") must be positive");
...
triangle_index const& mesh_basic::connectivity(int const index) const
{
    ASSERT_CPE(index>=0,"Index ("+std::to_string(index)+") must be positive");
